package com.shantoo.calendar.library.tickertimer.entities;

import android.content.Context;

import com.shantoo.calendar.library.tickertimer.utils.SystemUtil;

/**
 * 语言对象抽象父类
 * DatePicker暂且支持中文和英文两种显示语言
 * 如果你需要定义更多的语言可以新建自己的语言类并继承Language重写其方法即可
 * 同时你需要在Language的单例方法{@link #getLanguage(Context)}的分支语句中添加自己的语言类判断
 ...
 * override all method.
 * Also you must add a judge of your language in branching statement of single case method{@link #getLanguage(Context)}
 *
