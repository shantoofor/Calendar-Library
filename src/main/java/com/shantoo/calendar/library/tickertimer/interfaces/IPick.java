package com.shantoo.calendar.library.tickertimer.interfaces;

import com.shantoo.calendar.library.tickertimer.views.DatePicker;

/**
 * 日历控件方法接口
 * 所有可供调用的方法都会在此定义
 * The interface of DatePicker{@link DatePicker}
...
public interface IPick {
     ...
     * Set the primary colour of DatePicker{@link DatePicker}
